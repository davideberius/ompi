...
int ompi_mpi_spc_message_boundary = 12288;
int ompi_mpi_spc_comm_boundary = 64;
...
int ompi_mpi_register_params(void)
{
    ...
    ompi_mpi_spc_message_boundary = 12288;
    (void) mca_base_var_register("ompi", "mpi", NULL, "spc_message_boundary",
                                 ...
                                 OPAL_INFO_LVL_4,
                                 MCA_BASE_VAR_SCOPE_READONLY,
                                 &ompi_mpi_spc_message_boundary);

    ompi_mpi_spc_comm_boundary = 64;
